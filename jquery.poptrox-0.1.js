        ...
        jQuery.fn.poptrox = function(options) {
                ...
                // Settings
                        ...
                        var settings = jQuery.extend({
                                        ...
                                        popupTextColor:                                 'rgba(0,0,0,0)',                                              // (Default Style) Popup text color (when usePopupStyling = true)
                                        popupLoaderTextSize:                    '2em',                                                  // (Default Style) Popup loader text size
                                        popupCloserBackgroundColor:             '#DCDCDC',                                              // (Default Style) Popup closer background color (when usePopupStyling = true)
                                        popupCloserTextColor:                   '#000000',                                              // (Default Style) Popup closer text color (when usePopupStyling = true)
                                        popupCloserTextSize:                    '20px',                                                 // (Default Style) Popup closer text size
                                        popupPadding:                                   0,                                                             // (Default Style) Popup padding (when usePopupStyling = true)
                                        popupCaptionHeight:                             0,                                                             // (Default Style) Popup height of caption area
